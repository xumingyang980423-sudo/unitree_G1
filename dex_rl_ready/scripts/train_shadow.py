"""Shadow hand in-hand cube reorientation RL training (SKRL PPO, Direct workflow)."""
...
parser.add_argument("--task", type=str, default="Isaac-Repose-Cube-Shadow-Direct-v0")
...
log_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "logs", "shadow"))
os.makedirs(log_dir, exist_ok=True)
agent_cfg.experiment.directory = log_dir
agent_cfg.experiment.experiment_name = "shadow_cube_repose"
agent_cfg.experiment.checkpoint_interval = 500

print(f"[INFO] Training {args_cli.train_iters} iterations")
print(f"[DEBUG] obs_space: {env.observation_space.shape}, act_space: {env.action_space.shape}")
