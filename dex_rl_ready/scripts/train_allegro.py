"""Allegro hand in-hand cube reorientation RL training (SKRL PPO)."""
...
parser.add_argument("--task", type=str, default="Isaac-Repose-Cube-Allegro-v0")
...
log_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "logs", "allegro"))
os.makedirs(log_dir, exist_ok=True)
agent_cfg.experiment.directory = log_dir
agent_cfg.experiment.experiment_name = "allegro_cube_repose"
