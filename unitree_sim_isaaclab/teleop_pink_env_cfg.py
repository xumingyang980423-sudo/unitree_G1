...
def _tune_robot_for_teleop(env_cfg) -> None:
    ...
    hands = ImplicitActuatorCfg(
        ...
        stiffness={
            ...
            "R_thumb_proximal_pitch_joint": 175.0,
            "R_thumb_proximal_yaw_joint": 175.0,
            "R_thumb_intermediate_joint": 120.0,
            "R_thumb_distal_joint": 100.0,
        },
        damping={
            "R_index_proximal_joint": 32.0,
            "R_index_intermediate_joint": 28.0,
            "R_middle_proximal_joint": 32.0,
            "R_middle_intermediate_joint": 28.0,
            "R_ring_proximal_joint": 40.0,
            "R_ring_intermediate_joint": 40.0,
            "R_pinky_proximal_joint": 40.0,
            "R_pinky_intermediate_joint": 40.0,
            "R_thumb_proximal_pitch_joint": 24.0,
            "R_thumb_proximal_yaw_joint": 24.0,
            "R_thumb_intermediate_joint": 20.0,
            "R_thumb_distal_joint": 18.0,
        },
    )
